...
public class DaySixOne {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        System.out.println("How many lights are lit? " + howManyLightsLit(myLights));
    }

    public static ArrayList<String> pullingDataFromFile(String path) throws FileNotFoundException {
        URL url = DaySixOne.class.getResource(path);
    ...
    public static ArrayList<String[]> separateCommand(ArrayList<String> data){
        ...
        for (String command:
           ...
           // System.out.println(Arrays.toString(firstCoordinates));
    ...
    public static int howManyLightsLit(int[][] grid){
        int count = 0;
        for (int i = 0; i < grid.length; i++) {
